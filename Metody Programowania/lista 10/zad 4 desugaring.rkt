...
(define (desugaring [e : Exp]) : Exp
  (type-case Exp e
    [(numE n) e]
    [(opE o l r) (opE o (desugaring l) (desugaring r))]
    [(ifE o l r) (ifE o (desugaring l) (desugaring r))]
    [(condE cs)
     (desugaring (cond->if cs))]))
