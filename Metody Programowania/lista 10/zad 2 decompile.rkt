...
(define (do-ins stack ins)
  (if (empty? ins) (first stack)
      (type-case Instr (first ins)
        [(pushI n) (do-ins (cons (numE n) stack) (rest ins))]
        [(opI o) (do-ins (update-stack
                          stack (opE o (second stack) (first stack))) (rest ins))])))
